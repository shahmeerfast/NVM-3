...
import { FaFacebook, FaGoogle, FaInstagram, FaLinkedin, FaEye, FaEyeSlash } from "react-icons/fa";
    ...
    <div className="fixed inset-0 bg-black bg-opacity-60 flex justify-center items-center z-[100] p-4 min-h-screen">
      <div className="bg-white p-8 rounded-2xl shadow-xl max-w-lg w-full">
        ...
        <div className="flex gap-4 justify-center md:mb-8 mb-4">
          <button className="btn btn-outline flex items-center gap-3 px-4 py-2 rounded-xl border-2 border-blue-600 text-blue-600 hover:bg-blue-600 hover:border-blue-700 hover:text-white focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-500 transition-all transform active:scale-95">
            <FaFacebook size={25} />
          </button>

          <button className="btn btn-outline flex items-center gap-3 px-4 py-2 rounded-xl border-2 border-[#4285F4] text-[#4285F4] hover:border-[#4285F4] hover:bg-[#4285F4] hover:text-white focus:outline-none focus:border-[#4285F4] focus:ring-2 focus:ring-[#4285F4] transition-all transform active:scale-95">
            <FaGoogle size={25} />
          </button>
          ...
          <button className="btn btn-outline flex items-center gap-3 px-4 py-2 rounded-xl border-2 border-[#0077B5] text-[#0077B5] hover:border-[#0077B5] hover:bg-[#0077B5] hover:text-white focus:outline-none focus:border-[#0077B5] focus:ring-2 focus:ring-[#0077B5] transition-all transform active:scale-95">
            <FaLinkedin size={25} />
          </button>
        </div>
